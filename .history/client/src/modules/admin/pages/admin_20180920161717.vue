<template>
    <div>
        <el-form method="post" enctype="multipart/form-data">
            ...
            <el-form-item>
                <single-pic-upload class="left-pic" :file="left_image" path="home/article-kof-avert/" name="article-pic" :width="200" :height="200" @success="uploadLeftSuccess" @remove="removeLeftPic"></single-pic-upload>
            </el-form-item>
            <el-form-item>
