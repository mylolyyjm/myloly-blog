<template>
    <div>
        <el-form method="post" enctype="multipart/form-data">
            ...
            <el-form-item>
                <el-upload drag action="" :http-request="ossUpload" multiple>
...
<script>
    ...
    export default {
        ...
        methods: {
            async ossUpload(file_name, file) {
                try {
                    ...
                    if (res.res.status === 200) {
                        this.$refs.pic_.$img2Url(file_name, 'http://article-images.oss-cn-beijing.aliyuncs.com/' + save_path)
                    } else {
