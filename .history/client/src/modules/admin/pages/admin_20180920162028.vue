<template>
    <div>
        <el-form method="post" enctype="multipart/form-data">
            ...
            <el-form-item>
                <single-pic-upload style="width:200px;height:200px;" :file="article_pic" path="article/pic/" name="article_pic" :width="200" :height="200" @success="uploadSuccess" @remove="removePic"></single-pic-upload>
            </el-form-item>
            <el-form-item>
