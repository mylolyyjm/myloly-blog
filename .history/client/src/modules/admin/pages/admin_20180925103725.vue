...
<script>
    ...
    export default {
        ...
        created() {
            let param_arr = window.location.href.split('/');
            let test_text = param_arr[param_arr.length - 2];
            let article_id = param_arr[param_arr.length - 1];
            if (test_text == 'article' && article_id) {
